...
class Applications(Resource):
    ...
    @queries_records
    def get(self):
        return EntityManager.get_rows_by_filter(APPLICATION, get_filters_from_query_string()), 200
    ...
    @queries_records
    def patch(self):
        return list(map(lambda x: x.to_dict(), EntityManager.patch_entities(APPLICATION, request.json))), 200
...
class ApplicationsCount(Resource):
    ...
    def get(self):
        ...
        return EntityManager.get_filtered_row_count(APPLICATION, filters), 200
...
class ApplicationsFindOne(Resource):
    ...
    def get(self):
        filters = get_filters_from_query_string()
        return EntityManager.get_first_filtered_row(APPLICATION, filters), 200
